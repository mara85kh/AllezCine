...
getGenreMovies(
  "https://api.themoviedb.org/3/genre/movie/list?api_key=9d5193a47774f74778d917ef7c2ce95f&language=en-US"
);
...
function displayGenre(genre) {
  ...
  document.getElementsByClassName("movieGenre")[0].innerHTML =
    arrMovieGenre.join(" - ");
}
